...
func (a *Assistant) SearchAround(keywords string, withOptions ...func(*url.Values)) (any, bool) {
...
func (a *Assistant) ReGEO(address string, withOptions ...func(*url.Values)) (any, bool) {
